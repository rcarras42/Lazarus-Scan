...
begin
  ...
  // TDelphiTwain.Create
  // Bind method Twain.OnTwainAcquire with TwainTwainAcquire (.. := @..)

  // Load the library

  // Select the source.
  // Make a quick popup info to indicate that will be required only once !
  // Write into a flat file here like a .cfg ..

  // Load and enable source (not the UI !)
